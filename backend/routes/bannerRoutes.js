...
router.post('/add-banner', authenticate, authorize('admin'), bannerMediaUpload, validateAddBanner, addBanner);
router.delete('/delete-banner', authenticate, authorize('admin'), validateDeleteBanner, deleteBanner);
router.put('/update-banner', authenticate, authorize('admin'), bannerMediaUpload, validateUpdateBanner, updateBanner);
