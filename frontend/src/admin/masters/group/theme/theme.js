/**
 * Central color theme for the Group Master feature.
 *
 * Every component in this feature should pull its colors (and semantic
 * variant choices for shared components like Button/Badge/Switch) from here
...
const theme = {
  ...
  // Badge variant per groupType, used on the list table.
  groupTypeBadge: {
    PRODUCT: 'blue',
    CATEGORY: 'purple',
    USER: 'green',
