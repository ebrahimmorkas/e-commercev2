...
/**
 * Loads companyMaster (drives isAdminAddingUserFeatureAllowed) and the
 * location-tax bundle (drives the cascading Country -> State -> City
 * dropdowns, restricted to this vendor's CompanyMaster.allowedCountries).
 * Mirrors admin/features/products/hooks/useProductLookups.js's companyMaster +
 * location bundle fetch, minus the tax-specific derivations this page
 * doesn't need.
 */
export const useAddUserLookups = () => {
...
export default useAddUserLookups;
